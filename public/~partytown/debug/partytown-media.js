...
((self) => {
    const [getter, setter, callMethod, constructGlobal, definePrototypePropertyDescriptor, randomId, WinIdKey, InstanceIdKey, ApplyPathKey] =
        self.$bridgeToMedia$;
    ...
    const initCanvas = (WorkerBase, win) => {
        ...
        const getWebGlMethodCallType = (methodName) =>
            methodName.startsWith('create') || methodName.startsWith('get') || methodName.startsWith('is') || ctxWebGLGetterMethods.includes(methodName)
                ? 1
                : 2;
