...
((e) => {
    const t = () => {},
        ...
        n = (e) => {
            ...
            try {
                const t =
                    null === (n = null === (r = null == e ? void 0 : e.__zone_symbol__originalInstance) || void 0 === r ? void 0 : r.constructor) ||
                    void 0 === n
                        ? void 0
                        : n.name;
                if (t) return t;
    ...
    const $ = e.parent,
        ...
        A = (e, t, r, s, a) =>
            void 0 !== t && (s = typeof t)
                ...
                : t,
        M = (e, t, r, n, i, o, a, l) => {
            if (((o = {}), !r.has(t))) for (a in (r.add(t), t)) s(a) && ((l = t[a]), (n || 'function' != typeof l) && (i || '' !== l) && (o[a] = A(e, l, r)));
            return o;
        },
        I = (e) => {
            let t,
        ...
        x = 'cssText,selectorText,href,media,namespaceURI,prefix,name,conditionText'.split(','),
        R = async (e, t) => {
            let n,
                i,
                s,
                      ...
                      : (t.x ||
                            ...
                            ((e, t, n) => {
                                let i,
                                    ...
                                    l = (r, n) => e.postMessage([10, { V: t, q: r, b: A(t, Array.from(n)) }]);
                                if (
                                    ((n._ptf = void 0),
                                    a.map((e) => {
                                        (s = n),
            ...
            if (0 === s) {
                const e = (() => {
                    const e = b.createElement('i'),
                        ...
                        d = [D('Window', $), D('Node', t)],
                        h = {
                            i: JSON.stringify(S, (e, t) => ('function' == typeof t && (t = String(t)).startsWith(e + '(') && (t = 'function ' + t), t)),
                            v: k(u, d),
